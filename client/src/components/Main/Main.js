        ...
        <div className='min-h-[calc(100vh-100px)] flex flex-col justify-center items-center mx-10'>
            ...
            <div className='relative h-fit min-h-[70vh] border-b-2 border-black my-10 py-10 sm:flex-col sm:w-fit sm:h-fit sm:min-h-[45vh]'>
                <div className='w-[60%] float-right sm:w-full sm:mb-5'>
                    <h2 className=' text-9xl sm:text-5xl'>Chat with CHAT-GPT 3.5 NOW</h2>
                </div>  
            ...
            <div className='relative h-fit min-h-[70vh] border-b-2 border-black my-10 py-10 sm:flex-col sm:w-fit sm:h-fit sm:min-h-[45vh]'>
                <div className='w-[60%] sm:w-full sm:mb-16'>
                    <h2 className=' text-9xl sm:text-5xl'>Summarize any Online Article OR Text</h2>
                </div>
            ...
            <div className='relative h-fit min-h-[70vh] border-b-2 border-black my-10 py-10 sm:flex-col sm:w-fit sm:h-fit sm:min-h-[45vh]'>            
                <div className='w-[60%] float-right sm:w-full sm:mb-5'>
                    <h2 className=' text-9xl sm:text-5xl'>Translate To And From Over 50+ Languages</h2>
                </div>
            ...
            <div className='relative h-fit min-h-[70vh] border-b-2 border-black my-10 py-10 sm:flex-col sm:w-fit sm:h-fit sm:min-h-[45vh]'>
                <div className='w-[60%] sm:w-full sm:mb-16'>
                    <h2 className=' text-9xl sm:text-5xl'>Transcribe Any Audio Using WHISPER AI</h2>
                </div>
