...
const Main = () => {
  return (
    <div className='min-h-[calc(100vh-73px)] flex flex-col justify-center items-center mx-10'>
        <div className='relative h-fit min-h-[70vh] border-b-2 border-black my-10 py-10 sm:flex-col sm:w-fit sm:h-fit sm:min-h-[40vh]'>
            <div className='w-[60%] sm:w-full sm:mb-5'>
                <h1 className=' text-9xl sm:text-7xl'>Create Images From Prompts With DALLE-E</h1>
            </div>

            <div className='w-[25%] float-right flex justify-center items-center sm:static sm:w-full sm:absolute sm:bottom-0'>
        ...
        <div className='relative h-fit min-h-[70vh] border-b-2 border-black my-10 py-10 sm:flex-col sm:w-fit sm:h-fit sm:min-h-[40vh]'>
            ...
            <div className='w-[25vw]  flex  justify-center items-center sm:static sm:w-full sm:absolute sm:bottom-0'>
        ...
        <div className='relative h-fit min-h-[70vh] border-b-2 border-black my-10 py-10 sm:flex-col sm:w-fit sm:h-fit sm:min-h-[40vh]'>
            ...
            <div className='w-[25vw] float-right h-[10vw] flex justify-center items-center sm:static sm:w-full sm:absolute sm:bottom-0'>
        ...
        <div className='relative h-fit min-h-[70vh] border-b-2 border-black my-10 py-10 sm:flex-col sm:w-fit sm:h-fit sm:min-h-[40vh]'>
            ...
            <div className='w-[25vw] float-right flex  justify-center items-center sm:static sm:w-full sm:absolute sm:bottom-0'>
